...
#define NUM_OF_CHARS_IN_FONT	127		//Support for 127 characters
...
void fonts_init(void){
	...
	for( uint32_t i=0; i<NUM_OF_CHARS_IN_FONT; i++ ){
	...
	font.num_lines  = 3;
	font.lines[0] = (VideoLine){	.init = (VideoXY){ .x=0, 		 .y=0 },				.end = (VideoXY){ .x=0, 		.y=-BOX_HEIGHT } };
	font.lines[1] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH, .y=-BOX_HEIGHT },		.end = (VideoXY){ .x=BOX_WIDTH, .y=0 }	};
	font.lines[2] = (VideoLine){	.init = (VideoXY){ .x=0, 		 .y=-BOX_HEIGHT/2 },	.end = (VideoXY){ .x=BOX_WIDTH, .y=-BOX_HEIGHT/2 } };
  ...
  font.lines[2] = (VideoLine){
	...
	font.lines[3] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT },	.end = (VideoXY){ .x=BOX_WIDTH/2, .y=0 }			};
	...
	// -- EXCLAMATION MARK --
	font.num_lines  = 2;
	font.lines[0] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=0 },							.end = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(1.0/5.0) }	};
	font.lines[1] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(3.0/5.0)  },		.end = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT}	};
	...
	font.num_lines  = 6;
	font.lines[0] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=0 },							.end = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(1.0/5.0) } };
	font.lines[1] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(3.0/5.0)  },		.end = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(3.0/5.0)}	};
	font.lines[2] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(3.0/5.0)  },		.end = (VideoXY){ .x=BOX_WIDTH,   .y=-BOX_HEIGHT*(3.0/5.0)}	};
	font.lines[3] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH,   .y=-BOX_HEIGHT*(3.0/5.0)  },		.end = (VideoXY){ .x=BOX_WIDTH,   .y=-BOX_HEIGHT}	};
	font.lines[4] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH,   .y=-BOX_HEIGHT },				.end = (VideoXY){ .x=0,  		  .y=-BOX_HEIGHT}	};
	font.lines[5] = (VideoLine){	.init = (VideoXY){ .x=0,   		   .y=-BOX_HEIGHT },				.end = (VideoXY){ .x=0,  		  .y=-BOX_HEIGHT*(5.0/6.0) }	};
	...
	// -- COLON --
	font.num_lines  = 2;
	font.lines[0] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(3.0/6.0) },		.end = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(4.0/6.0) } };
	font.lines[1] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT*(1.0/6.0)  },		.end = (VideoXY){ .x=BOX_WIDTH/2, .y=0						} };
	...
	// -- LEFT PAREN --
	font.num_lines  = 2;
	font.lines[0] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT },		.end = (VideoXY){ .x=0, .y=-BOX_HEIGHT/2 } };
	font.lines[1] = (VideoLine){	.init = (VideoXY){ .x=0, 		   .y=-BOX_HEIGHT/2  },		.end = (VideoXY){ .x=BOX_WIDTH/2, .y=0						} };
	...
	// -- RIGHT PAREN --
	font.num_lines  = 2;
	font.lines[0] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT },		.end = (VideoXY){ .x=BOX_WIDTH,   .y=-BOX_HEIGHT/2 } };
	font.lines[1] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH,   .y=-BOX_HEIGHT/2  },		.end = (VideoXY){ .x=BOX_WIDTH/2, .y=0						} };
	...
	// -- PLUS --
	font.num_lines  = 2;
	font.lines[0] = (VideoLine){	.init = (VideoXY){ .x=0, .y=-BOX_HEIGHT/2 },		.end = (VideoXY){ .x=BOX_WIDTH,   .y=-BOX_HEIGHT/2 } };
	font.lines[1] = (VideoLine){	.init = (VideoXY){ .x=BOX_WIDTH/2, .y=-BOX_HEIGHT },		.end = (VideoXY){ .x=BOX_WIDTH/2,   .y=0 } };
